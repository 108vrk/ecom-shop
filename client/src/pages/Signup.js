        ...
        <div className="signup_service_header">
          <div className="signup_service_left">
            <div className="signup_service_left_signbox">
              <Link to="/signup">
                <h1 className="signup_service_left_head">Signup</h1>
              </Link>
              <Link to="/signin">
                <h1 className="signin_service_left_head">Signin</h1>
              </Link>
            </div>
            ...
            <div className="signup_service_inputs">
              ...
              <a href="" style={{ paddingLeft: "10px", color: "#ff6800" }}>
                Get code
              </a>
              <p
                className="worker_registration-paralogin"
              ...
              >
                ...
                <Link
                  to="/workerlogin"
                  className="worker_registration-login"
                  style={{ color: "#ff6800" }}
                >
                  &nbsp;User Agreement
                </Link>
              ...
              <div className="signup_service_buttons">
                <div className="signup_service_signup_button_div">
                  <Link to="sign-up">
                    <button className="signup_service_button" type="submit">
                      Signup
                    </button>
                  </Link>
                </div>
