      ...
      <div className="home">
        ...
        <div className="slider">
          <Carousel fade>
            <Carousel.Item>
              <img
                src="https://i02.appmifile.com/118_operator_in/03/01/2022/dc051f8facdb3b063c0d140692bd011f.jpg"
                alt=""
        ...
        <div className="starProductBx">
          <div className="box" id="rightBx">
            <Link to="/categories">
              <img
                src="https://i02.appmifile.com/341_operator_in/30/05/2021/e866f96094c058af222f53bc97bcb5ed.jpg?width=612&height=612"
                alt="startProduct"
              />
            </Link>
            <Link to="/categories">
              <img
                src="https://i02.appmifile.com/402_operator_in/15/04/2021/d6d00b5cb2a212f4a9a13d4d7c1bdcc1.png?width=612&height=612"
                alt="startProduct"
              />
            </Link>
            <Link to="/categories">
              <img
                src="https://i02.appmifile.com/571_operator_in/22/10/2020/2df7eba98e739b3329dda041b05a0aac.jpg?width=612&height=612"
                id="wide"
                alt="startProduct"
              />
            </Link>
          ...
          <div className="box" id="leftBx">
            <Link to="/categories">
              <img
                src="https://i02.appmifile.com/427_operator_in/09/05/2021/4cedd9d52d3d66e09ee27dde3914efe1.jpg?width=612&height=612"
                alt="startProduct"
              />
            </Link>
          </div>
          <div className="starProductBx_circle">
            <h4>EXPLORE</h4>
          </div>
        </div>
        ...
        <div className="hotAccessoriesMenuBx">
          <div className="dropdown">
            ...
            <div className="hotAccessories" style={{ left: "-25vw" }}>
              <div>
                <img
                  src="https://i01.appmifile.com/webfile/globalimg/in/cms/500BFA0B-CBEF-5DFF-79A9-E925F9F2FEE9.jpg"
                  alt="Cover"
                />
              </div>
              {/* --2ndpart */}
          ...
          <div className="dropdown">
            ...
            <div className="hotAccessories" style={{ left: "-33vw" }}>
              <div>
                <img
                  src="https://i02.appmifile.com/953_operator_in/17/06/2021/e12dde416676486fed36d0503d5bd65a.jpg"
                  alt="Cover"
                />
              </div>
              {/* --2ndpart */}
          ...
          <div className="dropdown">
            ...
            <div className="hotAccessories" style={{ left: "-43vw" }}>
              <div>
                <img
                  src="https://i02.appmifile.com/663_operator_in/20/01/2021/0f6ac3c219428b6decbe7fb03d479060.jpg"
                  alt="Cover"
                />
              </div>
              {/* --2ndpart */}
          ...
          <div className="dropdown">
            ...
            <div className="hotAccessories" style={{ left: "-48vw" }}>
              <div>
                <img
                  src="https://i02.appmifile.com/677_operator_in/25/01/2021/8163c3c89feb2c83c73b019d5fd50181.jpg"
                  alt="Cover"
                />
              </div>
              {/* --2ndpart */}
              <div id="rightDiv">
                ...
                <div className="box">
                  <Link to="/categories">
                    ...
                    <div className="info">
                      <span className="proName">
                        Mi KN-95 Protective Mask (Pack of 5)
                      </span>
          ...
          <div className="dropdown">
            ...
            <div className="hotAccessories" style={{ left: "-55vw" }}>
              <div>
                <img
                  src="https://i01.appmifile.com/webfile/globalimg/in/cms/801ED76B-614B-5959-E2C3-1EC8E14C0ABD.jpg"
                  alt="Cover"
                />
              </div>
              {/* --2ndpart */}
